local method, path = ...
if method == "POST" then
	if _GET.master_code1 and _GET.master_code0 == pcchrono.master_code and _GET.master_code1 == _GET.master_code2 then
		pcchrono.master_code = _GET.master_code1
	end
	if _GET.admin_code1 and _GET.admin_code0 == pcchrono.admin_code and _GET.admin_code1 == _GET.admin_code2 then
